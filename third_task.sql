Задача №3
Таблица client_calls_table содержит данные с количеством сообщений в чате за каждый 
день. Нужно написать SQL-запрос, который выведет количество сообщений в чате банка с 
