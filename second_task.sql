Задача №2
Таблица client_table содержит данные о дате каждого звонка клиента в контакт-центр. 
Нужно написать SQL запрос, который посчитает количество уникальных клиентов, 
позвонивших в контакт-центр, за каждый месяц.
